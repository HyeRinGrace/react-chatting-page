...
import{Row,Col,InputGroup,FormControl,Image,Accordion} from 'react-bootstrap';
import {AiOutlineSearch} from 'react-icons/ai';
import { FaLockOpen,FaLock } from 'react-icons/fa';
import {MdFavorite, MdFavoriteBorder} from 'react-icons/md';
import { child, onValue, ref, update ,remove} from 'firebase/database';
  ...
  return (
    <div style={{
      ...
      <Row>
        <Col>
        <h2>
          {isPrivateChatRoom? <FaLock style = {{marginBottom:10}}/>:<FaLockOpen/>}
          {" "}
          <span>{currentChatRoom?.name}</span>
          {" "}
          {!isPrivateChatRoom && 
          <span style={{cursor:'pointer'}} onClick={handleFavorite}>
            {isFavorite?<MdFavorite style={{marginBottom:10}}/>
